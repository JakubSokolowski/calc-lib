import { DoubleRepresentation, FloatProperty, SingleRepresentation } from './floatRepresentation'
...
describe('SingleRepresentation constructor test', () => {
  it('constructs valid single representation from binary string', () => {
    ...
    let rep = new SingleRepresentation(input, FloatProperty.Normalized)
...
describe('DoubleRepresentation constructor test', () => {
  it('constructs valid single representation from binary string', () => {
    ...
    let rep = new DoubleRepresentation(input, FloatProperty.Normalized)
    expect(rep.sign).toEqual('0')
